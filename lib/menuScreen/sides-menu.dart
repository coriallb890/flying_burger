      ...
      child: Scaffold (
        ...
        body: GridView.count(
          ...
          children: const <Widget>[
            menuItem('Beans', 'assets/images/placeholder.png'),
            menuItem('Coleslaw', 'assets/images/sides/coleslaw.jpg'),
            menuItem('Corn', 'assets/images/sides/corn.jpg'),
            menuItem('Fried Okra', 'assets/images/placeholder.png'),
            menuItem('Fries', 'assets/images/sides/fries.jpg'),
            menuItem('Green Tomatoes', 'assets/images/placeholder.png'),
            ...
            menuItem('Onion Rings', 'assets/images/placeholder.png'),
            menuItem('Potatoes', 'assets/images/sides/potatoes.jpg'),
            menuItem('Rice', 'assets/images/placeholder.png'),
            menuItem('Rice & Beans', 'assets/images/placeholder.png'),
            menuItem('Small Caesar', 'assets/images/salads/small-cae.jpg'),
            menuItem('Small Salad', 'assets/images/salads/small-sal.jpg'),
            menuItem('Zucchini & Squash', 'assets/images/placeholder.png'),
          ],
        ),
